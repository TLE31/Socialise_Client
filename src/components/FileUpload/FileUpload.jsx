  ...
  const uploadPostHandler = async () => {
    ...
    try {
      const post = await axios.post(
        "https://socialise-server.onrender.com/api/v1/posts/",
      ...
      if (i > 0) {
        res1 = await axios.post(
          `https://socialise-server.onrender.com/api/v1/posts/images/${post.data.data.id}`,
          formData1,
          {
            headers: {
      ...
      if (v > 0) {
        res2 = await axios.post(
          `https://socialise-server.onrender.com/api/v1/posts/videos/${post.data.data.id}`,
          formData2,
          {
            headers: {
              "Content-Type": "multipart/form-data",
