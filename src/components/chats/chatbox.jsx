...
const socket = io("https://socialise-server.onrender.com/");
...
const Chatbox = ({ messageReceive }) => {
  ...
  const blockHandler = async () => {
    try {
      ...
      const block = await axios.put(
        `https://socialise-server.onrender.com/api/v1/user/blockUser/${selectChat._id}`,
        {},
        {
          headers: {
  ...
  const unblockHandler = async () => {
    try {
      ...
      const unblock = await axios.put(
        `https://socialise-server.onrender.com/api/v1/user/unblockUser/${selectChat._id}`,
        {},
        {
          headers: {
            authorisation: `Bearer ${token}`,
      ...
      if (selectChat._id == messageReceive.senderId) {
        ...
        try {
          ...
          const del = axios.delete(
            `https://socialise-server.onrender.com/api/v1/messageNotification/${selectChat._id}`,
            {
              headers: {
                authorisation: `Bearer ${token}`,
              },
  ...
  const getMessages = async (id) => {
    ...
    try {
      const mess = await axios.get(
        `https://socialise-server.onrender.com/api/v1/messages/${id}`,
        {
          headers: {
            authorisation: `Bearer ${token}`,
          },
  ...
  const selectChatHandler = (id) => {
    ...
    try {
      const del = axios.delete(
        `https://socialise-server.onrender.com/api/v1/messageNotification/${id}`,
        {
          headers: {
            authorisation: `Bearer ${token}`,
          },
    ...
    if (!disabled && messageInput !== "") {
      ...
      try {
        const mess = await axios.post(
          `https://socialise-server.onrender.com/api/v1/messages/${selectChat._id}`,
          data,
          {
            headers: {
              authorisation: `Bearer ${token}`,
  ...
  const deleteChat = async (id) => {
    ...
    try {
      const mess = await axios.delete(
        `https://socialise-server.onrender.com/api/v1/messages/delete/${id}`,
        {
          headers: {
            authorisation: `Bearer ${token}`,
          },
