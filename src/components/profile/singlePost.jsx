  ...
  const deleteHandler = async (id) => {
    ...
    try {
      const res = await axios.delete(
        `https://socialise-server.onrender.com/api/v1/posts/${id}`,
        {
          headers: {
    ...
    try {
      if (isLiked) {
        ...
        const res = await axios.put(
          `https://socialise-server.onrender.com/api/v1/posts/unlike/${post.id}`,
          {},
          {
            headers: {
        ...
        const token = localStorage.getItem("token");
        const res = await axios.put(
          `https://socialise-server.onrender.com/api/v1/posts/like/${post.id}`,
          {},
          {
            headers: {
              authorization: `Bearer ${token}`,
