    ...
    const getDetails = async () => {
      ...
      try {
        user1 = await axios.get(
          `https://socialise-server.onrender.com/api/v1/user/getProfile/${id}`,
          {
            headers: {
        ...
        posts1 = await axios.get(
          `https://socialise-server.onrender.com/api/v1/all_posts/profile/${id}`,
          {
            headers: {
              authorisation: `Bearer ${token}`,
            },
    ...
    const getFollows = async () => {
      try {
        let follows = await axios.get(
          `https://socialise-server.onrender.com/api/v1/user/getFollows/${id}`,
          {
            headers: {
              authorisation: `Bearer ${token}`,
            },
