...
const Comments = ({ comments, id, commentsState }) => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const res = await axios.put(
        `https://socialise-server.onrender.com/api/v1/posts/comment/${id}`,
        {
          comment: comments1,
        },
        {
  ...
  const deleteHandler = async (commentId) => {
    try {
      const res = await axios.delete(
        `https://socialise-server.onrender.com/api/v1/posts/comment/${id}/${commentId}`,
        {
          headers: {
            "Content-Type": "application/json",
          },
  ...
  const editHandler = async (e) => {
    ...
    try {
      const res = await axios.put(
        `https://socialise-server.onrender.com/api/v1/posts/comment/${id}/${edit.id}`,
        {
