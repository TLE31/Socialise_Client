      ...
      try {
        ...
        if (token) {
          ...
          const user1 = await axios.get(
            "https://socialise-server.onrender.com/api/v1/user"
          );
      ...
      try {
        ...
        if (token) {
          ...
          const notificationOfMessages = await axios.get(
            "https://socialise-server.onrender.com/api/v1/messageNotification"
          );
      ...
      try {
        ...
        if (token) {
          ...
          const notification = await axios.get(
            "https://socialise-server.onrender.com/api/v1/notifications"
          );
      ...
      try {
        ...
        if (token) {
          ...
          const users = await axios.get(
            "https://socialise-server.onrender.com/api/v1/user/getAllUsers"
          );
